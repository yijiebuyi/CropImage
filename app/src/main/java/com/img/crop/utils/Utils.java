...
public class Utils {
    ...
    /*public static String formatTimeString(Context context, long time) {
        ...
        if (cal.get(Calendar.YEAR) == c.get(Calendar.YEAR) && cal.get(Calendar.MONTH) == c.get(Calendar.MONTH)
                && cal.get(Calendar.DAY_OF_MONTH) == c.get(Calendar.DAY_OF_MONTH)) {// today
            ...
            return c.get(Calendar.HOUR_OF_DAY) + ":" + minute;
        } else if (cal.get(Calendar.YEAR) == c.get(Calendar.YEAR) && cal.get(Calendar.MONTH) == c.get(Calendar.MONTH)
                && (cal.get(Calendar.DAY_OF_MONTH) - c.get(Calendar.DAY_OF_MONTH)) == 1) {// yestoday
            return context.getResources().getString(R.string.yesterday);
        } else if (cal.get(Calendar.YEAR) == c.get(Calendar.YEAR) && cal.getTimeInMillis() - c.getTimeInMillis() > 24*60*60*1000) {// x月x日
            return (c.get(Calendar.MONTH)+1) + context.getResources().getString(R.string.cloud_month) + c.get(Calendar.DAY_OF_MONTH)
                    + context.getResources().getString(R.string.cloud_day);
        } else if (cal.get(Calendar.YEAR) - c.get(Calendar.YEAR) != 1) {// xx/xx/xx
            return c.get(Calendar.YEAR)+"/"+(c.get(Calendar.MONTH)+1)+"/"+cal.get(Calendar.DAY_OF_MONTH);
        }
        return c.get(Calendar.YEAR)+"/"+(c.get(Calendar.MONTH)+1)+"/"+cal.get(Calendar.DAY_OF_MONTH);
    }
    ...
    public static String formatTime(Context context, long time) {
        ...
        if (cal.get(Calendar.YEAR) == c.get(Calendar.YEAR) && cal.get(Calendar.MONTH) == c.get(Calendar.MONTH)
            ...
            return c.get(Calendar.HOUR_OF_DAY) + ":" + minute;
        } else if (yestodayCalendar(c)) {// yestoday
            return context.getResources().getString(R.string.yesterday);
        } else if (cal.getTimeInMillis() - c.getTimeInMillis() <= 86400000 * 6) {
            int weekday = c.get(Calendar.DAY_OF_WEEK);// SUNDAY=1
            if (weekday == 1) {
        ...
        } else if (cal.get(Calendar.YEAR) == c.get(Calendar.YEAR)) {// x月x日
            return (c.get(Calendar.MONTH)+1) + context.getResources().getString(R.string.cloud_month)
                    + c.get(Calendar.DAY_OF_MONTH) + context.getResources().getString(R.string.cloud_day);
        } else if (cal.get(Calendar.YEAR) - c.get(Calendar.YEAR) != 1) {// xx年xx月xx日
            return c.get(Calendar.YEAR) + context.getResources().getString(R.string.cloud_year)
                    + (c.get(Calendar.MONTH) + 1) + context.getResources().getString(R.string.cloud_month)
                    + cal.get(Calendar.DAY_OF_MONTH) + context.getResources().getString(R.string.cloud_day);
        }
        return c.get(Calendar.YEAR)+"."+(c.get(Calendar.MONTH)+1)+"."+cal.get(Calendar.DAY_OF_MONTH);
    }

    private static boolean yestodayCalendar(Calendar yestoday) {
        Calendar cal = Calendar.getInstance();
        cal.add(Calendar.DAY_OF_MONTH, -1);
        return cal.get(Calendar.YEAR) == yestoday.get(Calendar.YEAR) && cal.get(Calendar.MONTH) == yestoday.get(Calendar.MONTH)
                && cal.get(Calendar.DAY_OF_MONTH) == yestoday.get(Calendar.DAY_OF_MONTH);
    }*/
}
