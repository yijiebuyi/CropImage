...
public class BitmapUtils {
    ...
    public static Bitmap resize(Bitmap bitmap, int size, boolean recycle) {
        ...
        Canvas canvas = new Canvas(target);
        Paint paint = new Paint(Paint.FILTER_BITMAP_FLAG | Paint.DITHER_FLAG);
        canvas.drawBitmap(bitmap, new Rect(0,  0, w, h), new Rect(0,  0, width, height),  paint);;
        if (recycle) bitmap.recycle();
        return target;
    }
    ...
    public static Bitmap resizeAndCropBySideLength(Bitmap bitmap, int maxLength, boolean recycle, boolean isVideo) {
        ...
        if (width == maxLength && height == maxLength) return bitmap;
    ...
    public static boolean isSupportedByRegionDecoder(String mimeType) {
        ...
        return mimeType.startsWith("image/") &&
                (!mimeType.equals("image/gif") && !mimeType.endsWith("bmp") && !mimeType.endsWith("tif") && !mimeType.endsWith("tiff"));
    }
